<template>
    ...
    <div justify="center">
      <v-dialog v-model="dialogItem" persistent max-width="600px">
        <v-card>
          <v-card-title>
            ...
            <v-container>
              <v-row>
                ...
                <v-col cols="12" sm="6" md="4">
                  ...
                  <v-select
                    :items="dimencoesItem"
                    label="Selecione a dimencionalidade do item*"
                    hint="representa a unidade de medida do item"
                    required
                  ></v-select>
                </v-col>
